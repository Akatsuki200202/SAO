...
class Parser:
    ...
    def set_arguments(self):
        ...
        self.parser.add_argument('--target_loss_weight', type=float, default=1,
                            help="Weight of optimize outter trigger generator")
        self.parser.add_argument('--homo_loss_weight', type=float, default=1,
                            help="Weight of optimize similarity loss")
        self.parser.add_argument('--orthogonal_loss_weight', type=float, default=0.5,
                            help="Weight of optimize similarity loss")
        self.parser.add_argument('--sim_loss_weight', type=float, default=1,
                            help="Weight of optimize similarity loss")
        self.parser.add_argument('--trigger_loss_weight', type=float, default=0.5,
