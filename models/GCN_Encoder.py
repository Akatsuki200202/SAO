...
class GCN_Encoder(nn.Module):
    ...
    def __init__(self, nfeat, nclass,nhid=32,dropout=0.5, lr=0.01, weight_decay=5e-4, layer=2,device=None,use_ln=False,layer_norm_first=False):
    ...
    def _train_with_val(self, labels, idx_train, idx_val, train_iters, verbose):
        ...
        for i in range(train_iters):
            ...
            acc_val = function_utils.accuracy(output[idx_val], labels[idx_val])
